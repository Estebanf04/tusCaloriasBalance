...
export default function Form() {
  ...
  return (
    <form 
    className="space-y-5 bg-gray-50 shadow-2xl p-10 rounded-lg font-medium"
    onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-1 gap-3">
            ...
            <input
             ...
             placeholder="Ej. Comida, Jugo de Naranja, Ensalada, Ejercicio, Pesas, Caminata, Bicicleta, Etc."
             value={activity.name}
             onChange={handleChange}
              />
        </div>
